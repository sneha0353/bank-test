...
const Withdrawhistory = () => {
    ...
    const WithrawDate = () => {
        fetch("http://localhost:7000/api/getwithdrawdate",{
            method:"post",
            headers:{
    ...
    useEffect(()=>{
        fetch("http://localhost:7000/api/getwithdrawhistory",{
            method:'get',
            headers:{
                Authorization:localStorage.getItem('token')
            }
    ...
    return(
        <div>
            ...
            <div>
                <div className="row">
                    <div className="col-6">
                        <h2 className="text-info mt-2">Withdraw History</h2>
                        {whistory ?
                            <div>
                                {flag ? 
                                    <div>
                                            ...
                                            return(
                                                <div class="card m-2" style={{width: "100%",borderRadius:'20px'}}>
                                                    <div class="card-body">
                                                        ...
                                                        <h5 class="card-title">Amount Withdrawn : <span className="text-danger">{item.wamount}</span></h5>
                                                        <h5 class="card-title">Withdrawal Date : <span className="text-danger">{item.date.slice(0,10)}</span></h5>
                                                    </div>
                                                </div>
                                            )
                                        })}
                    ...
                    <div className="col-6 ">
                        <h2 className="text-info mt-2">WithDraw History By Date</h2>
                                ...
                                {dateHistory.map(pp=>{
                                    ...
                                    <div class="card m-2" style={{width: "100%",borderRadius:'20px'}}>
                                        <div class="card-body">
                                            ...
                                            <h5 class="card-title">Amount Withdrawn : <span className="text-danger">{pp.wamount}</span></h5>
                                            <h5 class="card-title">Withdrawal Date : <span className="text-danger">{pp.date.slice(0,10)}</span></h5>
                                        </div>
                                    </div>
                                )
                            })}
